...
# Default build is production. Use --target dev for development
...
# Dev: Install packages needed to build gems
RUN apt-get update -qq && \
...
# Dev: Start the server by default, this can be overwritten at runtime
EXPOSE 3000
